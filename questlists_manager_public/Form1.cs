...
namespace questlists_manager
{
    public partial class questlists_manager : Form
    {
        ...
        int seaonVal = 0;       //�l���ǂ̃f�t�H���g�l�ɂ����v���Ȃ��ꍇ�A���̕ϐ��ɕۑ����ꂽ�l�����̂܂܃Z�[�u���Ɏg�p�����
        int courseVal = 0;
        ...
        private void buttonOpenFolder_Click(object sender, EventArgs e)
        {
            ...
            if (folderBrowser == DialogResult.OK)
            {
                ...
                if (isLoaded)
                {
                    ...
                    if (listQuest.SelectedIndex == -1 && listQuest.Items.Count != 0)    //�C���f�b�N�X���}�C�i�X(���I��)���A�����Œ�1�ȏ�̎�
                    {
        ...
        private void questlists_manager_Load(object sender, EventArgs e)
        {
            ...
            questDataDic.Add(1, str);       //database�̊e�N�G�X�g
            questDataDic.Add(2, str);       //database�̃N�G�X�g�̖��O����
        ...
        {
            if (listQuest.Items.Count != 0 && listQuest.SelectedIndex != -1)    //���X�g�ɂ���N�G�X�g����1�ȏォ�A�C���f�b�N�X���}�C�i�X�ł͂Ȃ���
            {
                List<string> list = questDataDic[0];
                ...
                if (by.Count != 0)
                {
                    ...
                    by.RemoveRange(0, 16);
                    byte[] byteData = by.ToArray();     //�V����byte[]�ɂ��Ă��邪���ɈӖ��͂Ȃ��Ǝv����
        ...
        private void buttonSaveAll_Click(object sender, EventArgs e)
        {
            ...
            {
                byte[] endNormal = { 18, 131, 89, 137, 91, 131, 58, 88, 182, 142, 89, 130, 204, 131, 88, 131, 88, 131, 129, 44, 151, 05, 65, 00, 00 };  //��ԍŌ�ȊO�̃N�G�X�g�̍Ō�
                byte[] end1 = { 00 }; //�ʏ�̃t�@�C���̈�ԍŌ�̃N�G�X�g
                byte[] end2 = { 00,00}; //��ԍŌ�̃t�@�C���̈�ԍŌ�̃N�G�X�g
                ...
                for (int r = 0; r < loopCount + 1; r++)
                {
                    if (r != loopCount)
                    {
                        ...
                        if (list.Count < 42)
                        {
                            count = list.Count;     //�N�G�X�g����42��菭�Ȃ��ꍇ
                        }
                        else
                        {
                            count = 42;
        ...
        {
            if (listQuest.Items.Count != 0 && listQuest.SelectedIndex != -1)     //0�̂Ƃ��͂����������s����Ȃ�
            {
        ...
        private void radioButtonDatabase_CheckedChanged(object sender, EventArgs e)
        {
            if (radioButtonDatabase.Checked)
            {
                ...
                if (fileNamesArray.Contains("database.bin"))
                {
                    ...
                    if (listDataabse.SelectedIndex == -1 && listDataabse.Items.Count != 0)    //�C���f�b�N�X���}�C�i�X(���I��)���A�����Œ�1�ȏ�̎�
                    {
